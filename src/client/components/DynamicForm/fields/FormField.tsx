...
export const FormField = ({
        ...
        return (
            <div key={formField.field} className="my-2">
                ...
                <Controller
                    ...
                    render={({ field }) => <CustomComponent {...field} readOnly={formField.readOnly} unit={formField.unit} />}
                />
            </div>
        );
    }
    ...
    switch (formField.type) {
        ...
        case "switch":
            return (
                <div key={formField.field} className="my-2 flex items-center gap-2 bg-white p-2 rounded-md">
                    <Controller
                        name={formField.field}
                        control={control}
                        render={({ field }) => (
                            <>
                                <label className="flex items-center cursor-pointer">
                                    <input
                                        ...
                                        className="hidden"
                                    />
                                    <div className={`w-12 h-6 rounded-full transition-colors ${field.value ? "bg-cyan-700" : "bg-gray-300"}`}>
                                        <div className={`w-6 h-6 bg-white rounded-full transform ${field.value ? "translate-x-6" : ""} transition-transform`}></div>
                                    </div>
                                </label>
                            </>
                        )}
