    ...
    <div className="flex items-center space-x-2 w-auto justify-end">
      <div className="relative w-auto">
        <div className="relative w-48 h-6 bg-gray-200 rounded-md overflow-hidden">
          ...
          >
            {value > 70 && (
              <span className="text-white font-semibold text-sm w-full text-center">
                {value}%
              </span>
            )}
          </div>
          {value < 70 && (
            <span className="absolute top-1/2 right-2 transform -translate-y-1/2 text-gray-700 font-semibold text-sm">
              {value}%
            </span>
          )}
        </div>
