...
function GeneralTab(props) {
    return (
        <div className="p-4">
            <FormField formField={{ type: "richtext", label: "Popis: ", field: "description", className: "mb-4" }} control={props.control} />
            <CollapsibleSection title="Soubor ze SŘ" className="mb-4" icon={FaFolderOpen}>
                <div>
