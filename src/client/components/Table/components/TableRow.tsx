    ...
    return (
        ...
        >
                ...
                <Checkbox
                    ...
                    onChange={(e) => {
                        if (e.target.checked) {
                            ...
                            setSelectedRows((prev: string[]) => prev.filter((id) => id !== guid));
                        }
                    }}
            ...
            <td className="px-4 py-2 text-right" onClick={(e) => e.stopPropagation()}>
                <RowMenu
                    onColorSelect={(color) => console.log('Цвет:', color)}
                    menuItems={[
                        {
                            label: 'Duplikovat…',
                            icon: <FaCopy />,
                            onSelect: () => console.log('Дублировать'),
                        },
                        {
                            label: 'Úkoly',
                            icon: <FaTasks />,
                            subItems: [
                                {
                                    label: 'Nový úkol…',
                                    icon: <FaPlus />,
                                    onSelect: () => console.log('Новый'),
                                },
                                {
                                    label: 'Hromadné úkoly…',
                                    onSelect: () => console.log('Хромадне'),
                                },
                                {
                                    label: 'Přiřazené úkoly…',
                                    onSelect: () => console.log('Прикреплённые'),
                                },
                            ],
                        },
                        {
