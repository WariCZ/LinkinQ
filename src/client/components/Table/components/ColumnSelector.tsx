...
function SortableItem({ id, label, onRemove }: SortableItemProps) {
    ...
    return (
        ...
        >
            ...
            >
                <RxDragHandleDots2 className="text-gray-400 hover:text-gray-600" size={18} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-h-[60vh] overflow-y-auto">
                <div className="space-y-3 mt-2">
                    {filteredColumns.map((c: any) => {
                        ...
                        return (
                            <label key={key} className="flex items-center gap-2 cursor-pointer pl-1">
                                <Checkbox
                        ...
                        <SortableContext items={localColumns} strategy={verticalListSortingStrategy}>
                            <div className="space-y-2">
                                {localColumns.map((key) => {
                                    ...
                                    return <SortableItem key={key} id={key} label={label} onRemove={handleRemoveColumn} />;
                                })}
                            </div>
                        </SortableContext>
                    </DndContext>
